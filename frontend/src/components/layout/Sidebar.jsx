...
export function Sidebar({ open, onClose }) {
    ...
    return (
        ...
        >
                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            <NavLink
                                ...
                                onClick={onClose}
                                className={clsx(
                                    'group relative block overflow-hidden rounded-[24px] border px-4 py-3.5 transition-all duration-200',
                                    active
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="min-w-0">
                                        ...
                                        <p className={clsx(
                                            ...
                                            active ? 'text-slate-600' : 'text-text-tertiary',
                                        )}>
                                            {item.description}
                                        </p>
                                    </div>
            ...
            <div className="relative border-t border-slate-200/80 bg-white/92 p-4">
                <div className="rounded-[26px] border border-slate-200/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(248,250,252,0.96))] p-4 shadow-[0_18px_36px_-32px_rgba(15,23,42,0.28)]">
                    ...
                    <button
                        type="button"
                        onClick={logout}
                        className="mt-4 inline-flex w-full items-center justify-center gap-2 rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm font-semibold text-text-secondary transition-colors hover:border-danger/15 hover:bg-danger/5 hover:text-danger"
                    >
